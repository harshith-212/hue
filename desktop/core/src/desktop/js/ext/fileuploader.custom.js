    ...
    qq.traditional.XhrUploadHandler = function(spec, proxy) {
        ...
        qq.extend(this, {
            ...
            uploadFile: function(id) {
                ...
                formData.append(this._options.request.inputName, file, file.name.normalize('NFC'));
                formData.append('dest', this._options.request.dest);

                const destination = encodeURIComponent(this._options.request.dest);
                var action = this._options.request.endpoint + "?dest=" + destination;
